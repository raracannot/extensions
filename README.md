...
| 扩展 | 版本 | 说明 |
| --- | --- | --- |
| Better_Experie[更好的体验] | 1.0.7 | 优化原生体验、扩展功能的 Blender 插件合集 |
| Spot Healing Brush (污点修复笔刷) | 1.0.1 | 基于 AI 的污点修复与智能抠图 |
| HDRI TOOL | 0.0.3 | 快速设置你的HDRI |
| [test][开发中]网格编辑工具集 | 2.3.3 | 网格编辑工具集 |
| MoI 3D Bridge | 0.0.3 | 通过 MoI 3D 后台转换并导入 STP 和 3DM 文件 |
...
| SKP Importer [导入SketchUp工程] | 0.1.1 | .skp文件导入导出、无需额外依赖 |
